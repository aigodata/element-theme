<template>
  <section class="page-form">
    <h2 id="form-biao-dan">
      <a href="#form-biao-dan" aria-hidden="true" class="header-anchor">¶</a>
      Form 表单
    </h2>
    <p>由输入框、选择器、单选框、多选框等控件组成，用以收集、校验、提交数据 ¶</p>

    <h3 id="dian-xing-biao-dan">
      <a href="#dian-xing-biao-dan" aria-hidden="true" class="header-anchor">¶</a>
      典型表单
    </h3>
    ...
    <h3 id="xing-nei-biao-dan">
      <a href="#xing-nei-biao-dan" aria-hidden="true" class="header-anchor">¶</a>
      行内表单
    </h3>
    ...
    <h3 id="dui-qi-fang-shi">
      <a href="#dui-qi-fang-shi" aria-hidden="true" class="header-anchor">¶</a>
      对齐方式
    </h3>
    ...
    <h3 id="biao-dan-yan-zheng">
      <a href="#biao-dan-yan-zheng" aria-hidden="true" class="header-anchor">¶</a>
      表单验证
    </h3>
